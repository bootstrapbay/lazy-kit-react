...
class Dropdowns extends React.Component {
  ...
  render () {
    return (
      <div>
        <h2>Dropdowns</h2>
        <p className="mb-5">Dropdowns are imported from <b>reactstrap</b> and styled with the <b>lazy kit</b>. For full documentation on how to use the Dropdown component, go <a href="https://reactstrap.github.io/components/alerts/" target="_blank">here</a>.</p>
